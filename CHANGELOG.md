...
#### Swap to FactoryBot
If you consume CRM as an engine and re-use any factories, you'll need to [upgrade to FactoryBot](https://github.com/thoughtbot/factory_bot/blob/4-9-0-stable/UPGRADE_FROM_FACTORY_GIRL.md).
...
`CRM::Permissions.save_with_permissions` is removed, use user_ids and group_ids inside attributes and call save
`CRM::Permissions.update_with_permissions` is removed, use user_ids and group_ids inside attributes and call update_attributes
...
Users with large amounts of records may find certain [database migrations](https://github.com/CRM/crm/blob/master/db/migrate/20180102075234_add_account_counter_caches.rb) taking a large amount of time, as each record is cached upfront.
...
Full list:
https://github.com/CRM/crm/compare/v0.13.5...v0.13.6
...
Full list:
https://github.com/CRM/crm/compare/v0.13.4...v0.13.5
...
Full list:
https://github.com/CRM/crm/compare/v0.13.3...v0.13.4
...
Full list:
https://github.com/CRM/crm/compare/v0.13.2...v0.13.3
...
Full list
https://github.com/CRM/crm/compare/v0.13.0...v0.13.1
...
- Added ActiveSupport lazy load hooks for all models in CRM.
...
Full changes:
https://github.com/CRM/crm/compare/v0.12.3...v0.13.0
...
Tue, Mar 16, 2013
---------------------------------------------------------------------
- Changed CRM license to MIT, see MIT-LICENSE file.

Sat, Dec 29, 2012 (0.11.4)
---------------------------------------------------------------------
- Updated countries list
-   Please see an important fix for country data: https://github.com/CRM/crm/wiki/The-Countries-Problem-and-How-to-Fix-It
...
- Added PrependEngineViews library module to let CRM plugins override default views.
...
Thu, Aug 5, 2010
---------------------------------------------------------------------
- CRM by default requires Rails 2.3.8.
...
- Updated README to mention http://demo.CRM.com
...
- Merged in I18n branch: CRM could be easily localized now by dropping in config/locales file.
...
Tue, Nov 24, 2009
---------------------------------------------------------------------
- Happy birthday, CRM is one year old!
...
Wed, Oct 21, 2009
---------------------------------------------------------------------
- Include modules from "lib/crm.rb" so that they're loaded when running rake.

Tue, Oct 20, 2009
---------------------------------------------------------------------
- Added Language option stubs to user's profile.
- Disabled tab highlighting when showing user's profile.
- Include all CRM modules from Rails initializer.
- Added CRM::I18n module.
...
Sun, Oct 11, 2009
---------------------------------------------------------------------
- Added full support for deploying CRM in subdirectory (see config/settings.yml).
...
- Refactored CRM::Callback.hook to simplify and support hook chains.
...
- Updated tab settings to allow CRM to run from a subdirectory (thanks, okyada!).
...
- First gathering at #CRM channel on irc.freenode.net (thanks, Eric!)
...
Mon, Jun 22, 2009
---------------------------------------------------------------------
- CRM website is up at http://www.CRM.com
...
Thu, Feb 26, 2009
---------------------------------------------------------------------
- Github commits are up on Twitter at http://twitter.com/CRM
...
Sat, Jan 17, 2009
---------------------------------------------------------------------
- Implemented CRM::Plugin and CRM::Callback modules.
- Created first sample CRM plugin!
...
- CRM now works with MySQL v4 and SQLite!
