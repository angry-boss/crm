  ...
  describe "assigned_entity_notification" do
    ...
    context "for an account" do
      ...
      it "sets fatfree as the sender" do
        expect(mail.from).to eql(["noreply@CRM.com"])
      end
      ...
      it "sets the subject" do
        expect(mail.subject).to eq("CRM: You have been assigned Ghostbusters Account")
      end
    ...
    context "for a contact" do
      ...
      it "sets the subject" do
        expect(mail.subject).to eq("CRM: You have been assigned Harold Ramis Contact")
      end
    ...
    context "for a lead" do
      ...
      it "sets the subject" do
        expect(mail.subject).to eq("CRM: You have been assigned Bill Murray Lead")
      end
    ...
    context "for an opportunity" do
      ...
      it "sets the subject" do
        expect(mail.subject).to eq("CRM: You have been assigned Big Opportunity")
      end
